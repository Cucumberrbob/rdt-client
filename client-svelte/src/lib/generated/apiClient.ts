...
export class SettingsClient {
		...
		if (status === 200) {
			return response.text().then((_responseText) => {
				...
				if (Array.isArray(resultData200)) {
					result200 = [] as any;
					for (let item of resultData200) result200!.push(SettingProperty.fromJS(item));
				} else {
					result200 = <any>null;
				}
				return result200;
	...
	protected processTestPath(response: Response): Promise<void> {
		...
		if (status === 200) {
			...
			return response.text().then((_responseText) => {
				...
				return throwException(
					'Invalid or empty path provided',
					status,
					_responseText,
					_headers,
					result400
	...
	testAria2cConnection(
		request: SettingsControllerTestAria2cConnectionRequest | undefined
	): Promise<string> {
	...
	protected processTestAria2cConnection(response: Response): Promise<string> {
		...
		if (status === 200) {
			...
			return response.text().then((_responseText) => {
				return throwException(
					'Invalid or missing connection details',
					status,
					_responseText,
					_headers
				);
...
export class TorrentsClient {
	...
	protected processGetAll(response: Response): Promise<Torrent[]> {
		...
		if (status === 200) {
			return response.text().then((_responseText) => {
				...
				if (Array.isArray(resultData200)) {
					result200 = [] as any;
					for (let item of resultData200) result200!.push(Torrent.fromJS(item));
				} else {
					result200 = <any>null;
				}
				return result200;
	 ...
	 */
	uploadFile(
		formData: TorrentControllerUploadFileRequest | null | undefined,
	...
	protected processUploadFile(response: Response): Promise<void> {
		...
		if (status === 200) {
			...
			return response.text().then((_responseText) => {
				...
				return throwException(
					'Invalid file or configuration provided',
					status,
					_responseText,
					_headers,
					result400
	...
	protected processUploadMagnet(response: Response): Promise<void> {
		...
		if (status === 200) {
			...
			return response.text().then((_responseText) => {
				...
				return throwException(
					'Invalid magnet link or configuration',
					status,
					_responseText,
					_headers,
					result400
	...
	): Promise<TorrentClientAvailableFile[]> {
	...
	protected processCheckFiles(response: Response): Promise<TorrentClientAvailableFile[]> {
		...
		if (status === 200) {
			return response.text().then((_responseText) => {
				...
				if (Array.isArray(resultData200)) {
					result200 = [] as any;
					for (let item of resultData200) result200!.push(TorrentClientAvailableFile.fromJS(item));
				} else {
					result200 = <any>null;
				}
				return result200;
	 ...
	 */
	checkFilesMagnet(
		request: TorrentControllerCheckFilesRequest | undefined
	): Promise<TorrentClientAvailableFile[]> {
	 ...
	 */
	verifyRegex(
		request: TorrentControllerVerifyRegexRequest | undefined
	): Promise<RegexVerificationResult> {
...
export class SettingsControllerTestAria2cConnectionRequest
	implements ISettingsControllerTestAria2cConnectionRequest
{
...
export class Torrent implements ITorrent {
	...
	init(_data?: any) {
		if (_data) {
			...
			this.filesSelected = _data['filesSelected']
				? new Date(_data['filesSelected'].toString())
				: <any>undefined;
			this.completed = _data['completed']
				? new Date(_data['completed'].toString())
				: <any>undefined;
			...
			if (Array.isArray(_data['downloads'])) {
				...
				for (let item of _data['downloads']) this.downloads!.push(Download.fromJS(item));
			}
			...
			if (Array.isArray(_data['files'])) {
				this.files = [] as any;
				for (let item of _data['files']) this.files!.push(TorrentClientFile.fromJS(item));
			}
			if (Array.isArray(_data['manualFiles'])) {
				this.manualFiles = [] as any;
				for (let item of _data['manualFiles']) this.manualFiles!.push(item);
			}
		}
	}
	...
	toJSON(data?: any) {
		...
		if (Array.isArray(this.downloads)) {
			data['downloads'] = [];
			for (let item of this.downloads) data['downloads'].push(item.toJSON());
		}
		...
		if (Array.isArray(this.manualFiles)) {
			data['manualFiles'] = [];
			for (let item of this.manualFiles) data['manualFiles'].push(item);
		}
		return data;
	}
}
...
export class Download implements IDownload {
	...
	init(_data?: any) {
		if (_data) {
			...
			this.added = _data['added'] ? new Date(_data['added'].toString()) : <any>undefined;
			this.downloadQueued = _data['downloadQueued']
				? new Date(_data['downloadQueued'].toString())
				: <any>undefined;
			this.downloadStarted = _data['downloadStarted']
				? new Date(_data['downloadStarted'].toString())
				: <any>undefined;
			this.downloadFinished = _data['downloadFinished']
				? new Date(_data['downloadFinished'].toString())
				: <any>undefined;
			this.unpackingQueued = _data['unpackingQueued']
				? new Date(_data['unpackingQueued'].toString())
				: <any>undefined;
			this.unpackingStarted = _data['unpackingStarted']
				? new Date(_data['unpackingStarted'].toString())
				: <any>undefined;
			this.unpackingFinished = _data['unpackingFinished']
				? new Date(_data['unpackingFinished'].toString())
				: <any>undefined;
			this.completed = _data['completed']
				? new Date(_data['completed'].toString())
				: <any>undefined;
	...
	toJSON(data?: any) {
		...
		data['link'] = this.link;
		data['added'] = this.added ? this.added.toISOString() : <any>undefined;
		data['downloadQueued'] = this.downloadQueued
			? this.downloadQueued.toISOString()
			: <any>undefined;
		data['downloadStarted'] = this.downloadStarted
			? this.downloadStarted.toISOString()
			: <any>undefined;
		data['downloadFinished'] = this.downloadFinished
			? this.downloadFinished.toISOString()
			: <any>undefined;
		data['unpackingQueued'] = this.unpackingQueued
			? this.unpackingQueued.toISOString()
			: <any>undefined;
		data['unpackingStarted'] = this.unpackingStarted
			? this.unpackingStarted.toISOString()
			: <any>undefined;
		data['unpackingFinished'] = this.unpackingFinished
			? this.unpackingFinished.toISOString()
			: <any>undefined;
		data['completed'] = this.completed ? this.completed.toISOString() : <any>undefined;
		data['retryCount'] = this.retryCount;
		data['error'] = this.error;
...
export class RegexVerificationResult implements IRegexVerificationResult {
	...
	toJSON(data?: any) {
		...
		if (Array.isArray(this.selectedFiles)) {
			data['selectedFiles'] = [];
			for (let item of this.selectedFiles) data['selectedFiles'].push(item.toJSON());
		}
		return data;
	}
}
